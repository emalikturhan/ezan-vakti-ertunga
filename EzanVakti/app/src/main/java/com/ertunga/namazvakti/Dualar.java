...
public class Dualar extends AppCompatActivity implements ListInterface {
        ...
        InterstitialAd.load(
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        // an ad is loaded.
                        Dualar.this.mInterstitialAd = interstitialAd;
                        showInterstitial();
                        interstitialAd.setFullScreenContentCallback(
                                new FullScreenContentCallback() {
                                    ...
                                    public void onAdDismissedFullScreenContent() {
                                        ...
                                        Dualar.this.mInterstitialAd = null;
    ...
    public void GetDualar(){
        ...
        UList.clear();
        String url = DefineUrl.Url+"?data=GetDualar";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for(int i=0; i<=ar.length(); i++){
                        ...
                        UList.add(new OneList(obj.getString("baslik"),obj.getString("data"),R.drawable.dua));
    ...
    public void Data(final String baslik, final String data) {
        ...
        Intent i = new Intent(Dualar.this,ListDetay.class);
        i.putExtras(b);
        startActivity(i);
