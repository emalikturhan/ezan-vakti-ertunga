...
public class Hadisler extends AppCompatActivity implements ListInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hadisler);
        loadAd();
        Init();
        Intents();
        Clicks();
        ...
        InterstitialAd.load(
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        // an ad is loaded.
                        Hadisler.this.mInterstitialAd = interstitialAd;
                        showInterstitial();
                        interstitialAd.setFullScreenContentCallback(
                                new FullScreenContentCallback() {
                                    ...
                                    public void onAdDismissedFullScreenContent() {
                                        ...
                                        Hadisler.this.mInterstitialAd = null;
    ...
    public void GetHadisler(){
        ...
        UList.clear();
        String url = DefineUrl.Url+"?data=GetHadisler";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for(int i=0; i<=ar.length(); i++){
                        ...
                        UList.add(new OneList(obj.getString("baslik"),obj.getString("data"),R.drawable.ic_paper));
    ...
    public void Data(final String baslik, final String data) {
        ...
        Intent i = new Intent(Hadisler.this,ListDetay.class);
        i.putExtras(b);
        startActivity(i);
