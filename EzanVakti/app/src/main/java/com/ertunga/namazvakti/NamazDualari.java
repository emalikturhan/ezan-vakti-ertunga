...
public class NamazDualari extends AppCompatActivity implements ListInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_namaz_dualari);
        loadAd();
        Init();
        Intents();
        Clicks();
        ...
        InterstitialAd.load(
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        // an ad is loaded.
                        NamazDualari.this.mInterstitialAd = interstitialAd;
                        showInterstitial();
                        interstitialAd.setFullScreenContentCallback(
                                new FullScreenContentCallback() {
                                    ...
                                    public void onAdDismissedFullScreenContent() {
                                        ...
                                        NamazDualari.this.mInterstitialAd = null;
    ...
    public void GetDualar(){
        ...
        UList.clear();
        String url = DefineUrl.Url+"?data=GetNamazDualari";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for(int i=0; i<=ar.length(); i++){
                        ...
                        UList.add(new OneList(obj.getString("baslik"),obj.getString("data"),R.drawable.ic_dua));
    ...
    public void Data(final String baslik, final String data) {
        ...
        Intent i = new Intent(NamazDualari.this,ListDetay.class);
        i.putExtras(b);
        startActivity(i);
