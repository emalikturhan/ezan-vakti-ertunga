...
import com.ertunga.namazvakti.Adaptors.ZikirAdaptors;
...
public class Zikirler extends AppCompatActivity implements ZikirInterFace {

    Functions functions = new Functions();
    private SharedPreferences sharedPreferences;
    RequestQueue rg;
    RecyclerView rc;
    ArrayList<ZikirList> UList;
    LinearLayoutManager LManager;
    private ZikirAdaptors adaptor;
    ...
    public void GetZikirler(){
        loaderbox.setVisibility(View.VISIBLE);
        UList.clear();
        String url = DefineUrl.Url+"?data=GetZikirler";
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for(int i=0; i<=ar.length(); i++){
                        ...
                        UList.add(new ZikirList(obj.getInt("id"),obj.getString("baslik"),obj.getString("okunusu"),obj.getString("meali"),obj.getString("arapca"),obj.getInt("adet"),R.drawable.ic_sureler));
                        adaptor = new ZikirAdaptors(UList);
    ...
    @Override
    public void Data(int id,String baslik, String okunus, String meali, String arapca, int adet) {
        Bundle b = new Bundle();
        b.putString("baslik",baslik);
        b.putString("okunus",okunus);
        b.putString("meali",meali);
        b.putString("arapca",arapca);
        b.putInt("adet",adet);
        b.putInt("id",id);
        Intent i = new Intent(Zikirler.this,ZikirDetay.class);
        i.putExtras(b);
        startActivity(i);
    }
