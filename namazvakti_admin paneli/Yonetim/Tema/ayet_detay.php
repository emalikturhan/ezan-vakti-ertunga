...
$baslik = "";
$icerik = "";
$cek = $db->prepare("SELECT * FROM Ayetler WHERE id =:id");
...
$ekle = $db->prepare("INSERT INTO Ayetler SET baslik=?,data=?");
...
$warning .= '</div>';
echo "<meta http-equiv='refresh' content='2;url=index.php?paginal=ayetler'>";
}
}
}
...
$guncelle = $db->prepare("UPDATE Ayetler SET baslik=?,data=? WHERE id=?");
...
<h2 class="page-header-title">Ayetler</h2>
<div>
<div class="page-header-tools">
<a href="index.php?paginal=ayetler" class="btn btn-gradient-03">Ayetler Listesi</a>
</div>
</div>
</div>
</div>
...
<label class="col-lg-2 form-control-label">Ayet Adı</label>
<div class="col-lg-10">
...
<div class="form-group row d-flex align-items-center mb-5">
<label class="col-lg-12 form-control-label">Ayet İçeriği</label>
<div class="col-lg-12">
