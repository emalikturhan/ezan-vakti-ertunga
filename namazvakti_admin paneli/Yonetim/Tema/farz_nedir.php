...
$up = $db->prepare("UPDATE DiniBilgiler SET farz=?");
...
$warning .= '</div>';
echo "<meta http-equiv='refresh' content='2;url=index.php?paginal=farz_nedir'>";
}
}
...
<h2 class="page-header-title">Farz Nedir</h2>
<div>
</div>
</div>
</div>
