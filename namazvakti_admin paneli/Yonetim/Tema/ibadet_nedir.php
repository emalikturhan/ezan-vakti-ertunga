...
$up = $db->prepare("UPDATE DiniBilgiler SET ibadet=?");
...
$warning .= '</div>';
echo "<meta http-equiv='refresh' content='2;url=index.php?paginal=ibadet_nedir'>";
}
}
...
<h2 class="page-header-title">İbadet Nedir</h2>
<div>
</div>
</div>
</div>
