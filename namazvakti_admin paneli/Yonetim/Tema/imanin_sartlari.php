...
$up = $db->prepare("UPDATE DiniBilgiler SET imanin_sartlari=?");
...
$warning .= '</div>';
echo "<meta http-equiv='refresh' content='2;url=index.php?paginal=imanin_sartlari'>";
}
}
...
<h2 class="page-header-title">İmanın Şartları</h2>
<div>
</div>
</div>
</div>
