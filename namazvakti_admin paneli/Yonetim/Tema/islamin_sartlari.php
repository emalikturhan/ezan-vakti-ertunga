...
$up = $db->prepare("UPDATE DiniBilgiler SET islamin_sartlari=?");
...
$warning .= '</div>';
echo "<meta http-equiv='refresh' content='2;url=index.php?paginal=islamin_sartlari'>";
}
}
...
<h2 class="page-header-title">İslamın Şartları</h2>
<div>
</div>
</div>
</div>
