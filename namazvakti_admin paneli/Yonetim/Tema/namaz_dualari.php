...
<a href="index.php?paginal=namaz_dualari_detay" class="btn btn-gradient-01">Yeni Namaz Dualası Ekle</a>
</div>
</div>
</div>
</div>
...
<h4 class="modal-title beyaz"><i class="icon-trash"></i> Namaz Duası Sil</h4>
</div>

<div class="modal-body">   
<div class="form" role="form">
<div class="form-group">
<label for="sart"><span style="font-size: 1.3em;color: #e91e63;">Uyarı:</span> Namaz Duası Silinecek !..</label>
...
$sil = $db->prepare("DELETE FROM NamazDualari WHERE id=?");
$sil->execute(array($oid));
if($sil->rowCount() > 0){
echo "<meta http-equiv='refresh' content='0;url=index.php?paginal=namaz_dualari'>";
}
}
?>
...
<tbody>
<?php
$cek = $db->prepare("SELECT * FROM NamazDualari Order By id Desc");
$cek->execute();
foreach ($cek as $key) {
?>
<tr>
...
<a href="index.php?paginal=namaz_dualari_detay&id=<?php echo $class->crypto($key["id"],"e");?>"><i class="la la-edit edit"></i></a>
