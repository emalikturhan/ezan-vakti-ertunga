...
$baslik = "";
$icerik = "";
$cek = $db->prepare("SELECT * FROM NamazSureleri WHERE id =:id");
...
$ekle = $db->prepare("INSERT INTO NamazSureleri SET baslik=?,data=?");
...
$warning .= '</div>';
echo "<meta http-equiv='refresh' content='2;url=index.php?paginal=namaz_sureleri'>";
}
}
}
...
$guncelle = $db->prepare("UPDATE NamazSureleri SET baslik=?,data=? WHERE id=?");
...
<h2 class="page-header-title">Namaz Suresi</h2>
<div>
<div class="page-header-tools">
<a href="index.php?paginal=namaz_sureleri" class="btn btn-gradient-03">Namaz Sureleri Listesi</a>
</div>
</div>
</div>
</div>
...
if($anahtar == 1){
?>
<h4>Namaz Suresi Güncelle</h4>
<?php
} else {
?>
<h4>Yeni Namaz Suresi Ekle</h4>
<?php
}
?>
</div>
...
<label class="col-lg-2 form-control-label">Sure Adı</label>
<div class="col-lg-10">
<input type="text" placeholder="Lütfen namaz suresi adı giriniz" name="baslik" class="form-control" value="<?php echo @$baslik; ?>">
</div>
</div>

<div class="form-group row d-flex align-items-center mb-5">
<label class="col-lg-12 form-control-label">Namaz Suresi İçeriği</label>
<div class="col-lg-12">
<textarea name="data" id="editor" rows="10" cols="80"  class="ckeditor"><?php echo @$icerik; ?></textarea>
</div>
</div>
