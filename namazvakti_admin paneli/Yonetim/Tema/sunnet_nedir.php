...
$up = $db->prepare("UPDATE DiniBilgiler SET sunnet=?");
...
$warning .= '</div>';
echo "<meta http-equiv='refresh' content='2;url=index.php?paginal=sunnet_nedir'>";
}
}
...
<h2 class="page-header-title">Sünnet Nedir</h2>
<div>
</div>
</div>
</div>
