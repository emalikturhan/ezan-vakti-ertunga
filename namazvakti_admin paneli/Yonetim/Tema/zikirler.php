...
<a href="index.php?paginal=zikir_detay" class="btn btn-gradient-01">Yeni Zikir Ekle</a>
</div>
</div>
</div>
</div>
...
<h4 class="modal-title beyaz"><i class="icon-trash"></i> Zikir Sil</h4>
</div>

<div class="modal-body">   
<div class="form" role="form">
<div class="form-group">
<label for="sart"><span style="font-size: 1.3em;color: #e91e63;">Uyarı:</span> Zikir Silinecek !..</label>
...
$sil = $db->prepare("DELETE FROM Zikirler WHERE id=?");
$sil->execute(array($oid));
if($sil->rowCount() > 0){
echo "<meta http-equiv='refresh' content='0;url=index.php?paginal=zikirler'>";
}
}
?>
...
<tbody>
<?php
$cek = $db->prepare("SELECT * FROM Zikirler Order By id Desc");
$cek->execute();
foreach ($cek as $key) {
?>
<tr>
...
<a href="index.php?paginal=zikir_detay&id=<?php echo $class->crypto($key["id"],"e");?>"><i class="la la-edit edit"></i></a>
